...
иллюзии = рулон
упоминание = 18
Латерна Меджика = Волшебный фонарь
Рейно = Праксиноскоп
Рейно = Звук
Рейно = Международный день анимации
зоотроп = Джордж
Владислав Старевич = Насекомые
рисованной = Эмиль
1440 = Мультфильм
популярными = Дисней
Старевича = 10,5
Союзмультфильм = 1936
Союзмультфильм = Союздетмультфильм
Варежка = Кукольная
1968 = Кошечка
Аннеси = Франция
композиций = Слои
последовательностью = Ключевых
Нарисованные = Кадрами
Заливка = однотонной
кппм = 1898
принято = Цирк лилипутов
принято = 24 кадров в секунду
рождения = 1877
кадры = графического редактора
кадры = нарисованные
примитивная = второй
порядок = Создание персонажей
Джеймсом Стюартом Блэктоном = Цирк лилипутов
физик Плато = 1832
физик Плато = Фенакистископ
1923 = Disney
СССР = Союзмультфильм
СССР = 1936
Тэдзуки = Аниме
...
дающий = Аниматор
вазах = зарождения
братьями = Кукольный театр
1877 рождения = 30
Очарованный = 1900
Комические = 1906
1965 = В квадрате 6X6
6X6 = Дамир Салимов и Юрий Петров
умирать = 80
длительного = max word
1990 = денег
совершенствованием = 2000
2016 = курсы
факторы = 2019
разработано = Autodesk
проекций = 3
Extrude = Выдавливается
рендеринга = Процесс
Вследствие =  Анимация
Twist = Создает
основной = Кнопки, Кадр
трехмерного = Omni
конуса или пирамиды = Target Spot
параллелепипеда и цилиндра = Target Direct
куполом = Skylight
Explode = Разорвать
Border = Plane
Reflection = Отражение
развиваться = В начале XX века, В Европе и Америке
подобные = В 40х
Animation = Одушевление или оживление, Размножение
Полезрения = Пространство
Линейная перспектива = Зрительного сокращения предметов на расстоянии
Перспектива = Кажущееся изменение форм и размеров предметов и их окраски на расстоянии
переднем = светотень
Pinnacle =  Захват–Монтаж–Вывод фильма,  max word
классической = 16, Рисованная анимация
примитивно = Перекладная
декорацию = Кукольная
Александр Татарский и Гарри Бардин мастерами = Пластилиновая
синтез = Создание
Direct Light Source = Прожектора
Ambient Light = равномерного
Paint = Работы с графическим изображением
Текстурированием = раскраски
Последний = Визуализация
Первый этап работы = Моделирование
заставить = Анимация
Вследствие = Анимация
Первый полнометражный = История игрушек
RenderMan = Средство
художественным = Молодой Шерлок Холмс
друг с другом общими сторонами = Примитивы
Cels = Эрлом Хердом и Джоном Брэем
традиционном = прозрачной
чернила и краски = Все ответы верны
японский = Anime
первый аниме = 1917
Пластилиновая = покадровой
Песочная = лёгкий
Особенная = Ротоскопирование
Основные = Все ответы верны
Унесённые = Хаяо Миядзаки
достоинством = Техническая
традиционная = движущихся
светящихся пантомим = анимации
Гохуа = китайской
праксиноскоп = Оптический
Пастушка и Трубочист = Поля Гримо
видеомагнитофон = 1956, Ampex
умолчанию = По отрезку прямой
Macromedia = Средствами
GIF = Бесплатная
4-х = max word
отличие = max word
процедуральная = Все ответы верны
предполагает = max word
Первый шаг = Создайте
Второй = Установите
Третий = Запустите
Четвертый = В нужном 
